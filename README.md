...
[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-htmldjango/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-htmldjango/actions/workflows/validate.yml)

Neovim tree-sitter queries for **htmldjango**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-htmldjango",
...
- [ ] Changes are scoped to `htmldjango` — do not include files for other languages
